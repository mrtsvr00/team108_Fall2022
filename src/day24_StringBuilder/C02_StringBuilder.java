...
public class C02_StringBuilder {
    public static void main(String[] args) {
        ...
        sb.toString().toUpperCase();//JAVA

        System.out.println(sb);//Java
        // StringBuilder i String e cevirirseniz veya String e donusturecek method lar kullanirsaniz
        // String in immutable ozelligi devreeye girer ve yapilan degisiklikler kalici olmaz
        ...
        System.out.println(sb.delete(5, sb.length()));// Baslangic indexi dahil, Bitis indexi dahil degil
