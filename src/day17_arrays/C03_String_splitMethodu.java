...
public class C03_String_splitMethodu {
    public static void main(String[] args) {
        ...
        //split methodu istedigimiz Stringi, istedigimiz ayrac kullanarak
        ...
        System.out.println("Verilen cumle sayisi : "+ spaceSplit.length);
